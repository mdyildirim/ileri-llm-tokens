...
export const translations: Record<'en' | 'tr', Translations> = {
    en: {
        ...
        keyFindings: {
            title: "Key Findings",
            perModelTitle: "Per-Model Language Impact",
            crossModelTitle: "Cross-Model Comparison",
            championsTitle: "Turkish Language Champions",
            diacriticTitle: "Diacritic Impact",
            vsEnglish: "vs English",
            vsTurkish: "vs Turkish",
            inTurkish: "in Turkish",
            inEnglish: "in English",
            costHigher: "{{value}}% higher cost",
            costLower: "{{value}}% lower cost",
            costSame: "same cost",
            speedSlower: "{{value}}% slower",
            speedFaster: "{{value}}% faster",
            speedSame: "same speed",
            tokensMore: "{{value}}% more tokens",
            tokensLess: "{{value}}% fewer tokens",
            tokensSame: "same tokens",
            fasterThan: "{{value}}% faster than",
            slowerThan: "{{value}}% slower than",
            cheaperThan: "{{value}}% cheaper than",
            moreExpensiveThan: "{{value}}% more expensive than",
            bestForTurkish: "Best for Turkish",
            worstForTurkish: "Worst for Turkish",
            lowestPenalty: "lowest token penalty",
            highestPenalty: "highest token penalty",
            tokenPenalty: "{{value}}% token penalty vs English",
            and: "and",
            diacriticSavings: "Removing ğ, ş, ı, ö, ü, ç saves tokens!",
            removingDiacritics: "Without diacritics",
            noSavings: "No significant savings",
        },
        analysis: {
    ...
    tr: {
        ...
        keyFindings: {
            ...
            perModelTitle: "Model Bazlı Dil Etkisi",
            crossModelTitle: "Modeller Arası Karşılaştırma",
            championsTitle: "Türkçe Şampiyonları",
            diacriticTitle: "Diyakritik Etkisi",
            vsEnglish: "İngilizce'ye karşı",
            vsTurkish: "Türkçe'ye karşı",
            inTurkish: "Türkçe'de",
            inEnglish: "İngilizce'de",
            costHigher: "%{{value}} daha pahalı",
            costLower: "%{{value}} daha ucuz",
            costSame: "aynı maliyet",
            speedSlower: "%{{value}} daha yavaş",
            speedFaster: "%{{value}} daha hızlı",
            speedSame: "aynı hız",
            tokensMore: "%{{value}} daha fazla token",
            tokensLess: "%{{value}} daha az token",
            tokensSame: "aynı token",
            fasterThan: "{{value}} daha hızlı",
            slowerThan: "{{value}} daha yavaş",
            cheaperThan: "{{value}} daha ucuz",
            moreExpensiveThan: "{{value}} daha pahalı",
            bestForTurkish: "Türkçe için En İyi",
            worstForTurkish: "Türkçe için En Kötü",
            lowestPenalty: "en düşük token cezası",
            highestPenalty: "en yüksek token cezası",
            tokenPenalty: "İngilizce'ye göre %{{value}} token cezası",
            and: "ve",
            diacriticSavings: "ğ, ş, ı, ö, ü, ç kaldırmak token tasarrufu sağlıyor!",
            removingDiacritics: "Diyakritik olmadan",
            noSavings: "Önemli tasarruf yok",
        },
        analysis: {
